						...
						<div class="topnav">
							<nav id="top-nav">
								<ul class="nav nav-sidebar">
                                    ...
                                    <li  class="active"><a href="DoanKhoa_QLThongBao.jsp"><span class="glyphicon glyphicon-wrench"></span><strong> Quản Lý Thông Báo</strong></a></li>
					...
					<div class="col-md-9">
						<div id="thongtin-thongbao">
							<div class="thongtinbar">
								<h4><p class="text-center"><strong>THÔNG TIN THÔNG BÁO</strong></p></h4>
							</div>
									...
									<div class="col-md-9">
										<div class="thongtin-container">
											<form class="form-horizontal">							
												...
												<div class="form-group">
												    <label for="" class="col-sm-5 control-label">Ngày diễn ra:</label>
												    <div class="col-sm-7">
												    	<input type="text" class="form-control" id="" value="">
												    </div>
												</div>
												<div class="form-group">
												    <label for="" class="col-sm-5 control-label">Trích đoạn:</label>
												    <div class="col-sm-7">
												...
												<div class="form-group">
												    <label for="" class="col-sm-5 control-label">Hình Ảnh:</label>
												    <div class="col-sm-7" style="margin-top: 5px">
												    	<input type="file" id="exampleInputFile">
												    </div>
												</div>
