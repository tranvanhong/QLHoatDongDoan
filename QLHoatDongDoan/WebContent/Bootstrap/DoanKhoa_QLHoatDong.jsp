						...
						<div class="topnav">
							<nav id="top-nav">
								<ul class="nav nav-sidebar">
                                    ...
                                    <li class="active"><a href="DoanKhoa_QLHoatDong.jsp"><span class="glyphicon glyphicon-wrench"></span><strong> Quản Lý Hoạt Động</strong></a></li>     
					...
					<div class="col-md-9">
						<div id="thongtin-tinnhan">
							<div class="thongtinbar">
								<h4><p class="text-center"><strong>THÔNG TIN HOẠT ĐỘNG</strong></p></h4>
							</div>
										...
										<div class="thongtin-container">
											<form class="form-horizontal">							
												<div class="form-group">
												    <label for="" class="col-sm-5 control-label">Mã Hoạt Động:</label>
												    <div class="col-sm-7">
												    	<input type="text" class="form-control" id="" value="HD01">
												    </div>
												</div>
												<div class="form-group">
												    <label for="" class="col-sm-5 control-label">Tên Hoạt Động:</label>
												    <div class="col-sm-7">
												    	<input type="text" class="form-control" id="" value="Hiếu Máu Nhân Đạo">
												    </div>
												</div>
												<div class="form-group">
												    <label for="" class="col-sm-5 control-label">Đoàn Viên Đề Xuất:</label>
												    <div class="col-sm-7">
												    	<input type="text" class="form-control" id="" value="Trần Văn Hồng">
												    </div>
												</div>
												<div class="form-group">
												    <label for="" class="col-sm-5 control-label">Thời Gian:</label>
												    <div class="col-sm-7">
												    	<input type="text" class="form-control" id="" value="7:30 21-09-2016">
												    </div>
												</div>
												<div class="form-group">
												    <label for="" class="col-sm-5 control-label">Địa Điểm:</label>
												    <div class="col-sm-7">
												    	<input type="text" class="form-control" id="" value="Phòng Y Tế">
												    </div>
												</div>
												<div class="form-group">
					         	...
					         	<table class="table table-striped">
				                    ...
				                    <tbody>			                        
				                        <tr>
				                            ...
				                            <td>Q9</td>
				                            <td><a>Chi Tiết</a></td>
                                             <td colspan="" rowspan="" headers=""><a href="#"><span class=""></span><strong> <h5>
				                        </tr>
				                       <tr>
				                            <td>HD04</td>
				                            <td>Chủ Nhật Xanh</td>
