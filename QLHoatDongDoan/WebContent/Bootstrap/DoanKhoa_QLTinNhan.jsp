						...
						<div class="topnav">
							<nav id="top-nav">
							   ...
							   <li><a href="DoanKhoa_DSHoatDong.jsp"> <span class="glyphicon glyphicon-th-list"></span><strong> Danh Sách Hoạt Động</strong></a></li>
                                    ...
                                    <li class="active"><a href="DoanKhoa_QLTinNhan.jsp"><span class="glyphicon glyphicon-wrench"></span><strong> Quản Lý Tin Nhắn</strong></a></li>
					...
					<div class="col-md-9">
						<div id="thongtin-tinnhan">
							<div class="thongtinbar">
								<h4><p class="text-center"><strong>THÔNG TIN TIN NHẮN</strong></p></h4>
							</div>
								...
								<div class="row">
										...
										<div class="thongtin-container">
											<form class="form-horizontal">							
												<div class="form-group">												
												    <label for="" class="col-sm-5 control-label">Người Nhận:</label>
												    <div class="col-sm-7">
									...
									<div class="col-md-3">
										<div class="thongtin-container">
											<div class ="button">
												<p>
												 	<button type="button" class="btn btn-primary btn-lg">GỮI</button>
												</p>
											</div>
										</div>									
									</div>   
