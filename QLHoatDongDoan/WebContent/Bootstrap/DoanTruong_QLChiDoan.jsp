						...
						<div class="topnav">
							<nav id="top-nav">
								<ul class="nav nav-sidebar">
									...
									<li class="active"><a href="DoanTruong_QLChiDoan.jsp" ><span class="glyphicon glyphicon-wrench"></span><strong> Quản Lý Chi Đoàn</strong></a></li>
					...
					<div class="col-md-9">
						<div id="thongtin-tinnhan">
							<div class="thongtinbar">
								<h4><p class="text-center"><strong>THÔNG TIN CHI ĐOÀN</strong></p></h4>
							</div>
										...
										<div class="thongtin-container">
											<form class="form-horizontal">							
												<div class="form-group">
												    <label for="" class="col-sm-5 control-label">Tên Chi Đoàn:</label>
												    <div class="col-sm-7">
												    	<input type="text" class="form-control" id="" value="Chất Lượng Cao">
												    </div>
												</div>
												<div class="form-group">
												    <label for="" class="col-sm-5 control-label">Cán Bộ Chi Đoàn:</label>
												    <div class="col-sm-7">
												    	<input type="text" class="form-control" id="" value="Trần Văn A">
												    </div>
												</div>
												<div class="form-group">
												    <label for="" class="col-sm-5 control-label">SĐT:</label>
												    <div class="col-sm-7">
												    	<input type="text" class="form-control" id="" value="012435513">
												    </div>
												</div>
												<div class="form-group">
												    <label for="" class="col-sm-5 control-label">Mail:</label>
												    <div class="col-sm-7">
												    	<input type="text" class="form-control" id="" value="CLC@gmail.com">
												    </div>
												</div>
											</form>
										</div>
