						...
						<div class="topnav">
							<nav id="top-nav">
								<ul class="nav nav-sidebar">
									...
									<li  class="active"><a href="Admin_DSTaiKhoan.jsp"> <span class="glyphicon glyphicon-th-list"></span><strong> Danh Sách Tài Khoản</strong></a></li>
								...
								<div class="row">
									<div class="col-md-3">
										<select>
											...
											<option value="">Mật Khẩu</option>
											<option value="">Quyền</option>
											<option value="">Lần Cuối Truy Cập</option>
										</select>
									</div>
									<div class="col-md-9">
