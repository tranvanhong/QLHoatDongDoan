						...
						<div class="topnav">
							<nav id="top-nav">
								<ul class="nav nav-sidebar">
									...
									<li class="active"><a href="DoanVien_XemDiem.jsp"><span class="glyphicon glyphicon-education"></span><strong> Xem Điểm</strong></a></li>
					...
					<div class="col-md-9">
						<div id="thongtin">
							<div class="thongtinbar">
								<h4><p class="text-center"><strong>ĐIỂM RÈN LUYỆN VÀ CÔNG TÁC XÃ HỘI</strong></p></h4>
							</div>
							<div class="thongtin-container">
								<table class="table table-bodered table-hover">
								  	<tr>
									 	<th class="text-center"><strong>Tên Hoạt Động Tham Gia</strong></th>
									 	<th class="text-center"><strong>Điểm Rèn Luyện</strong></th>
									 	<th class="text-center"><strong>Điểm Công Tác Xã Hội</strong></th>
									</tr>	
								  	<tr>
									 	<td class="text-center">Kết Nạp Đoàn Viên</td>
									 	<td class="text-center">5</td>
									 	<td class="text-center">5</td>
								 	</tr>
								 	<tr>
									 	<td class="text-center">Hiến Máu Nhân Đạo</td>
								...
								<div class="tongdiem">
									<hr>
									<p><strong>Tổng Điểm Rèn Luyện: 15 </strong></p>
									<p><strong>Tổng Điểm Công Tác Xã Hội: 15 </strong></p>
								</div>							
							</div>
						</div>
					</div>
